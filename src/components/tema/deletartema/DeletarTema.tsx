...
<div className="flex">
<button className="text-slate-100 bg-indigo-400 hover:bg-indigo-600 w-full py-2">Não</button>
<button className="text-slate-100 bg-red-400 hover:bg-red-600 w-full py-2">Sim</button>
</div>
      </div>
    </div>
  );
